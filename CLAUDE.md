...
- [PRD.md](doc/PRD.md) — vision produit, roadmap (v1.1 → v2.0)

## Architecture

**Stack : Vite + Alpine.js + Tailwind CSS + Zod + Vitest.**
...
src/
  ...
  lib/
    ...
    schema.js          # Schéma Zod + normalisation des imports
...
npm run test                  # vitest run (32 tests sur fonctions pures)
